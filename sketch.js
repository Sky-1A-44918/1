...
function preload() {
  // Carrega a imagem
  img = loadImage("imgs/1.jpg"); // Certifique-se de que o caminho está correto
}
...
function draw() {
  ...
  image(img, width / 2, 450, newWidth, newHeight); // Desenha a imagem centralizada e redimensionada
  ...
  text("O que é", 0, 0); // Texto atualizado
  pop();
}
